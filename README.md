...
│   ├── Code.ipynb                  # Mathematical proofs of gradients & initial implementation experiments
│   └── PDF_Format.pdf              # High-fidelity export of the notebook
│
├── Homework_#2_NN_Implementation/
│   ├── Code.ipynb                  # Building neural network components (Layers, Loss) from scratch
│   └── PDF_Format.pdf              # High-fidelity export
│
├── Homework_#4_CNN_Fashion_MINST/
...
│   └── PDF_Format.pdf              # High-fidelity export
│
├── Homework_#5_Transfer_Learning/
│   ├── Code.ipynb                  # Transfer Learning implementation using ResNet18
